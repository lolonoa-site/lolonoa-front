...
export default function VarLayout({ children }: Props) {
  ...
  return (
    <>
      <Input
        className="col-start-3 col-span-2 row-start-3 origin-right scale-[0.65] mt-[2rem] sm:col-start-5 sm:col-span-3 lg:col-start-7 lg:col-span-3 xl:col-start-7 xl:col-span-2"
        autoFocus={false}
        value={nameInput}
